...
class CacheManager:
    def __init__(self, host, port, password, *args, **kwargs):
        ...
        if connection_status:
            self.logger.info("Connection created succesfully")
    ...
    def store_data(self, key, value, time_to_live=None):
        try:
            ...
            self.logger.error(f"An error ocurred while storing data in Redis: {error}")
    ...
    def check_key(self, key):
        try:
            ...
            self.logger.error(f"An error ocurred while checking a key in Redis: {error}")
            return False, None
    ...
    def get_data(self, key):
        try:
            ...
            self.logger.error(f"An error ocurred while retrieving data from Redis: {error}")
    ...
    def delete_data(self, key):
        try:
            ...
            self.logger.error(f"An error ocurred while deleting data from Redis: {error}")
            return False
