...
app.add_url_rule(
    "/users/", defaults={"user_id": None}, view_func=user_view, methods=["GET", "POST"]
)
app.add_url_rule(
...
app.add_url_rule(
    "/rentals/", defaults={"rental_id": None}, view_func=rental_view, methods=["GET", "POST"]
)
app.add_url_rule(
    "/rentals/<int:rental_id>", view_func=rental_view, methods=["GET", "PUT", "DELETE"]
)
